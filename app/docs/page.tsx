    ...
    <main className="docs-main">
      ...
      <section className="doc-section" id="player-evaluation">
        ...
        <div className="docs-grid two">
          ...
          <div className="doc-card"><h3>Expected Points (Хүлээгдэж буй оноо)</h3><p>Official xP, form, xG/xA, байрлалын үзүүлэлт, defensive contribution, bonus боломж болон fixture-ийг эхлээд нэг projection болгоно. Дараа нь тоглох магадлалаар үржүүлнэ. Их байх тусам сайн.</p></div>
          ...
          <div className="doc-card"><h3>Freshness (Мэдээллийн шинэлэг байдал)</h3><p>Fresh → Aging → Stale → Missing дарааллаар эх сурвалжийн хугацааг харуулна. Хуучирсан first-choice мэдээлэл шинэ Official FPL/API-Football нотолгоогүй бол starter %, минут болон xP-ийг өсгөхгүй.</p></div>
        ...
        <div className="decision-flow"><span>Performance<br/><small>xG/xA, CS, bonus</small></span><b>+</b><span>Fixture<br/><small>1/3/5/8 GW</small></span><b>×</b><span>Appearance<br/><small>гараа + минут</small></span><b>=</b><span>xP<br/><small>таамаг оноо</small></span><b>−</b><span>Risk<br/><small>эрсдэл</small></span></div>
      ...
      <section className="doc-section" id="targets">
        ...
        <div className="docs-grid two">
          <div className="doc-card"><h3>Top Targets (Нийт шилдэг сонголтууд)</h3><p>Expected Points болон 3–5 GW projection үндсэн жинтэй. Value, appearance probability, risk нь бага тохируулга хийнэ. Fixture, минут, position upside нь xP-д аль хэдийн орсон тул дахин давхар нэмэхгүй.</p></div>
      ...
      <section className="doc-section" id="drafts">
        ...
        <p>Draft Builder нь бүхэл 15 тоглогчийн бүтцийг constrained beam optimizer-аар зэрэг харьцуулна. Эцсийн squad score нь зүгээр 15 тоглогчийн нийлбэр биш: хамгийн сайн хууль ёсны XI, captain-ийн нэмэлт оноо, captain тоглохгүй үеийн vice fallback, сэлгээ орох магадлал болон backup goalkeeper cover-ийг хамтад нь бодно.</p>
        <ul className="check-list"><li>2 GKP, 5 DEF, 5 MID, 3 FWD</li><li>Нийт үнэ £100.0m-оос хэтрэхгүй</li><li>Best/Safe draft GW1-д £0.5m, Alternative £1.0m buffer зорилтотой</li><li>Нэг багаас хамгийн ихдээ 3 тоглогч</li><li>Starting XI бүр strict starter gate: status, role, multi-source warning, starter confidence ≥72%, predicted minutes ≥65</li><li>Bench нь Starting XI-тэй адил үнэтэй 4 тоглогч биш: verified-high warning-гүй, backup биш, starter confidence ≥38%, predicted minutes ≥25, appearance probability ≥40% хямд emergency cover байна</li><li>Нэг хүнд fixture-ийн төлөө үнэтэй reserve авахгүй; ийм төлөвлөгөөт өөрчлөлтийг Season Roadmap болон free transfer шийднэ</li><li>Bench-ээс сулласан төсвийг ижил байрлалын найдвартай Starting XI upgrade-д автоматаар дахин зарцуулна</li><li>Limited data тоглогч Risk 0% авахгүй; pre-season uncertainty penalty хэрэглэнэ</li><li>Найман зөв formation-ийг харьцуулж хамгийн өндөр appearance-adjusted xP-тэй Starting XI сонгоно</li><li>Starting XI-ийн Evidence Coverage болон Official Warning-ийг Trust Gate-ээр шалгана; эх сурвалжийн тоог оноо болгон дахин нэмдэггүй</li><li>Price points, usable emergency cover, upgrade paths болон дараагийн 1, 3, 5, 8 Gameweek-ийн projection-ийг Flexibility Engine шалгана</li></ul>
        <div className="docs-callout"><b>Оноог давхар тооцохгүй:</b> Fixture, starter/minutes, xG/xA, clean sheet, defensive contribution болон bonus potential нь эхлээд Expected Points-д нэг удаа орно. Draft ranking дээр дахин тус тусад нь том bonus болгохгүй. Ингэснээр “хямд + fixture сайн” мөртлөө тоглохгүй тоглогч хэт дээгүүр гарах алдааг бууруулна.</div>
        <div className="docs-grid two">
        ...
        <div className="docs-callout"><b>Rules valid ≠ Final-ready:</b> Төсөв, байрлал, клубийн хязгаар зөв байсан ч Trust нь Verified болоогүй бол сайт багийг эцсийн санал гэж нэрлэхгүй. Pre-season баг дээр шинэ role, injury, transfer болон press мэдээллийг deadline-ийн өмнө заавал дахин шалгана.</div>
        <div className="docs-callout"><b>Critical Updates:</b> Best squad-д орсон тоглогчийн confirmed/corroborated injury, availability, transfer, rotation болон press мэдээллийг түрүүлж харуулна. Өмнөх verified scan-аас хойш нэмэгдсэн item `NEW` тэмдэгтэй. Зөрчилтэй trusted мэдээнээс authority ба published time-аар идэвхтэй claim сонгож, аль мэдээг penalty-д ашиглаагүйг тайлбарлана.</div>
        <div className="docs-callout"><b>My Team priority:</b> Entry эсвэл planned squad байгаа үед Critical Updates эхлээд таны 15 тоглогч, дараа нь боломжит transfer target, эцэст нь ерөнхий Best-draft context-ийг харуулна. Нэг утгатай олон headline нэг claim болж, хамгийн хүчтэй эх сурвалж болон нийт source count харагдана. Deadline decision нь captain/vice, transfer эсвэл hold, chip, XI/bench, critical risk-ийг нэг дор нэгтгэнэ.</div>
        <div className="docs-callout"><b>Squad Flexibility:</b> GW1-д бүх £100.0m-ийг заавал зарцуулахгүй. £0.5m buffer нь үнэ өссөн тоглогч руу нэг transfer-ээр шилжих боломж өгнө. Bench төсөв нь тухайн formation-д олдох хамгийн хямд usable cover дээр тулгуурлана; үлдсэн мөнгө Starting XI-д төвлөрнө. Planned rotation-ийг bench premium биш, free transfer roadmap шийднэ.</div>
        <p className="doc-note">Одоогийн free-first layer нь Official FPL player, fixture, history data, shortlist-д орсон тоглогчдын сүүлийн 8 хоногийн news RSS, клуб бүрийн official-domain news хайлт, мөн API-Football-оос олдсон club-friendly болон сүүлийн 21 хоногийн шигшээ багийн structured minutes-ийг ашиглана. Official club feed нь бүтэн/display нэр болон тухайн клуб дотор давхцаагүй surname-аар тоглогчтой холбогдоно. Official publisher-ийг яг hostname/subdomain-аар батална; нэр төстэй domain official болохгүй. Хоёр мэдээг corroborated гэж үзэхдээ зөвхөн ерөнхий category бус, ruled out/doubt/return/transfer зэрэг ижил claim-ийг шаардана. External minutes нь provider ID + одоогийн клуб + нэрийн баталгаажуулалт давсан үед л холбогдоно. Official club/FPL эх сурвалжийг хамгийн өндөр, BBC/Sky/The Athletic/Guardian/Reuters зэрэг эх сурвалжийг дараагийн түвшинд үнэлж, баталгаагүй secondary мэдээг дангаар нь хатуу penalty болгохгүй.</p>
      </section>
