  ...
  return <div className="docs-shell">
    ...
    <main className="docs-main">
      ...
      <section className="doc-section" id="drafts">
        ...
        <ul className="check-list"><li>2 GKP, 5 DEF, 5 MID, 3 FWD</li><li>Нийт үнэ £100.0m-оос хэтрэхгүй</li><li>Best/Safe draft GW1-д £0.5m, Alternative £1.0m buffer зорилтотой</li><li>Нэг багаас хамгийн ихдээ 3 тоглогч</li><li>Starting XI бүр strict starter gate: status, role, multi-source warning, starter confidence ≥72%, predicted minutes ≥65</li><li>Best/Alternative/Differential-ийн bench дээр зөвхөн verified-high warning-гүй, backup биш, starter ≥58%, minutes ≥50 тоглогч ашиглаж болно; Safe бүх 15-д strict gate хэрэглэнэ</li><li>Limited data тоглогч Risk 0% авахгүй; pre-season uncertainty penalty хэрэглэнэ</li><li>Найман зөв formation-ийг харьцуулж хамгийн өндөр appearance-adjusted xP-тэй Starting XI сонгоно</li><li>Starting XI-ийн Evidence Coverage болон Official Warning-ийг Trust Gate-ээр шалгана; эх сурвалжийн тоог оноо болгон дахин нэмдэггүй</li><li>Price points, playable bench, upgrade paths болон дараагийн 1, 3, 5, 8 Gameweek-ийн projection-ийг Flexibility Engine шалгана</li></ul>
