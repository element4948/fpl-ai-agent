  ...
  return <div className="docs-shell">
    ...
    <main className="docs-main">
      ...
      <section className="doc-section" id="drafts">
        ...
        <p className="doc-note">Одоогийн free-first layer нь Official FPL player, fixture, history data, shortlist-д орсон тоглогчдын сүүлийн 8 хоногийн news RSS, мөн API-Football-оос олдсон club-friendly болон сүүлийн 21 хоногийн шигшээ багийн structured minutes-ийг ашиглана. External minutes нь provider ID + одоогийн клуб + нэрийн баталгаажуулалт давсан үед л холбогдоно. Official club/FPL эх сурвалжийг хамгийн өндөр, BBC/Sky/The Athletic/Guardian/Reuters зэрэг эх сурвалжийг дараагийн түвшинд үнэлж, баталгаагүй secondary мэдээг дангаар нь хатуу penalty болгохгүй. Press conference-ийн бүрэн transcript болон API plan-д байхгүй тоглолтыг ашигласан мэт дүр эсгэхгүй.</p>
      </section>
